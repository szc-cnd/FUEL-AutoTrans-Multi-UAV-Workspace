...
target_reporting 做 TF 转换到 camera_init/channel
        |
        +--> 立即发布 /UAV0/target_reporting/observation
        |    并发送远程实时通道
        |
        v
...
/UAV0/thermal/target_candidate_pixel
...
- 发布到 `/UAV0/target_reporting/observation`；
...
```text
/UAV0/target_reporting/observation
```
...
```bash
rostopic echo /UAV0/color_tag_detector/candidate_text
rostopic echo /UAV0/vision/qr_candidate_detected
rostopic echo /UAV0/thermal/target_candidate_detected
```

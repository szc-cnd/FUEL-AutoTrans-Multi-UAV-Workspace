...
state[154] = acadoVariables.od[lRun1 * 4];
state[155] = acadoVariables.od[lRun1 * 4 + 1];
state[156] = acadoVariables.od[lRun1 * 4 + 2];
state[157] = acadoVariables.od[lRun1 * 4 + 3];
...
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 4];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 4 + 1];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 4 + 2];
acadoWorkspace.objValueIn[17] = acadoVariables.od[runObj * 4 + 3];
...
{ 17, 18, 19, 27, 28, 29, 37, 38, 39, 47, 48, 49, 57, 58, 59, 67, 68, 69, 77, 78, 79, 87, 88, 89, 97, 98, 99, 107, 108, 109, 117, 118, 119, 127, 128, 129, 137, 138, 139, 147, 148, 149, 157, 158, 159, 167, 168, 169, 177, 178, 179, 187, 188, 189, 197, 198, 199, 207, 208, 209 };
...
acadoVariables.lbAValues[41] = -2.9999999999999999e-01;
acadoVariables.lbAValues[42] = -2.9999999999999999e-01;
acadoVariables.lbAValues[43] = -2.9999999999999999e-01;
acadoVariables.lbAValues[44] = -2.9999999999999999e-01;
acadoVariables.lbAValues[45] = -2.9999999999999999e-01;
acadoVariables.lbAValues[46] = -2.9999999999999999e-01;
acadoVariables.lbAValues[47] = -2.9999999999999999e-01;
acadoVariables.lbAValues[48] = -2.9999999999999999e-01;
acadoVariables.lbAValues[49] = -2.9999999999999999e-01;
acadoVariables.lbAValues[50] = -2.9999999999999999e-01;
acadoVariables.lbAValues[51] = -2.9999999999999999e-01;
acadoVariables.lbAValues[52] = -2.9999999999999999e-01;
acadoVariables.lbAValues[53] = -2.9999999999999999e-01;
acadoVariables.lbAValues[54] = -2.9999999999999999e-01;
acadoVariables.lbAValues[55] = -2.9999999999999999e-01;
acadoVariables.lbAValues[56] = -2.9999999999999999e-01;
acadoVariables.lbAValues[57] = -2.9999999999999999e-01;
acadoVariables.lbAValues[58] = -2.9999999999999999e-01;
acadoVariables.lbAValues[59] = -2.9999999999999999e-01;
...
state[154] = acadoVariables.od[index * 4];
state[155] = acadoVariables.od[index * 4 + 1];
state[156] = acadoVariables.od[index * 4 + 2];
state[157] = acadoVariables.od[index * 4 + 3];
...
state[154] = acadoVariables.od[80];
state[155] = acadoVariables.od[81];
state[156] = acadoVariables.od[82];
state[157] = acadoVariables.od[83];
...
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 4];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 4 + 1];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 4 + 2];
acadoWorkspace.objValueIn[17] = acadoVariables.od[lRun1 * 4 + 3];
